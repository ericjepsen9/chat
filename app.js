...
function updateProfileDetailActions(){
  ...
  if($("profileSendMsgBtn")) $("profileSendMsgBtn").classList.toggle("hidden", !isFriend);
...
async function sendContactCardInChat(){
  ...
  await window.sendMessage({ type:'card', card:{ cardType:'名片', title: me.displayName || '名片', description:`ChatTrade ID：${me.appNumberId || me.username || '-'}`, meta:'个人名片', imageUrl: me.avatarUrl || '' } });
}
...
window.openSecondaryPage = (page, backTo = 'home') => {
  ...
  ["chatListView","friendListView","mallView","profileView","chatView","composerPanel","homeTabbar","profileDetailPage","messageSettingsPage","friendRequestsView","addFriendPage","scanPage","privacyPage", "qrCodePage", "editProfilePage", "publishProductPage", "myProductsPage", "settingsPage", "groupManagePage", "profileCartPage", "profileOrdersPage", "buyerOrdersManagePage", "sellerCenterPage", "sellerPaymentPage", "sellerOrdersPage", "sellerProductsPage", "productDetailPage", "orderDetailPage", "broadcastManagePage", "broadcastEditorPage", "forgotPasswordPage", "changePasswordPage"].forEach(id => { if($(id)) $(id).classList.add('hidden'); });
...
function bindAllEvents() {
  ...
  on("backBtn", "click", () => {
    try { stopScanCamera(); } catch(_) {}
      ...
      ["profileDetailPage","messageSettingsPage","friendRequestsView","addFriendPage","scanPage","privacyPage", "qrCodePage", "editProfilePage", "publishProductPage", "myProductsPage", "settingsPage", "groupManagePage", "profileCartPage", "profileOrdersPage", "buyerOrdersManagePage", "sellerCenterPage", "sellerPaymentPage", "sellerOrdersPage", "sellerProductsPage", "productDetailPage", "orderDetailPage", "broadcastManagePage", "broadcastEditorPage", "forgotPasswordPage", "changePasswordPage"].forEach(id => { if($(id)) $(id).classList.add('hidden'); });
...
function setMainTab(tab) {
  ...
  if (tab === 'messages') { if($("chatListView")) $("chatListView").classList.remove('hidden'); if($("chatTitle")) $("chatTitle").textContent = "微信"; loadConversations(); loadSystemMessages(); } 
